    ...
    → מיקומי אזור (סוג + משקל)
      ...
      <table className="help-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ממלא מכסות סוג קודם (המכסה הגדולה ראשונה), אחר כך מקומות כלליים; עם{" "}
              <code>pin_platoon</code> מעדיף פלוגה אחת ליום ועשוי לערבב פלוגות רק כשמכסה לא ניתנת למילוי בתוך הפלוגה
              המועדפת; במטריצה כל השמות בתא
            </td>
          </tr>
          <tr>
            <td>
      ...
      <table className="help-table">
        ...
        <tbody>
          ...
          <tr>
            <td>נעילת פלוגה (העדפת פלוגה אחת למשמרת צוות)</td>
            <td>
              <code>pin_platoon: true</code>
            </td>
            <td>
              נעילה אופטימית: מנסה <code>platoon_code</code> אחד ליום (לפי התאמה), ואז מושכת ממושב מכסה שלא ניתן למלא
              בתוך הפלוגה מפלוגות אחרות. מכסות של מושב יחיד (למשל <code>H: 1</code>) מניעות רוטציה גם כשמניין הסוג
              שונה בין פלוגות. <code>type_quotas</code> נשארים קשיחים. דורש פלוגה ברשימה.
            </td>
          </tr>
        </tbody>
      </table>
  ...
  config:
    ...
    pin_platoon: true`}
      ...
      <ul>
        ...
        <li>
          <strong>משרד צוות עם נעילת פלוגה:</strong> <code>full_day_team</code> עם סימון <strong>נעילת פלוגה</strong> (פלוגה
          אחת כשאפשר; ערבוב פלוגות רק למושבי מכסה חסרים); שייכו <strong>פלוגה</strong> ברשימת חיילים. ראו דוגמת YAML
          למעלה.
        </li>
        <li>
