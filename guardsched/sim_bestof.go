...
// RunSimulationBestOfZoneConfigExtend runs extend trials; fairness scores only the new segment.
func RunSimulationBestOfZoneConfigExtend(
	zone *ZoneConfig,
	...
	run := func(seed int64) ([]*AssignmentRecord, *SimulationStats, error) {
		rng := NewPyRandom(seed)
		return RunSimulationZoneConfigExtend(
